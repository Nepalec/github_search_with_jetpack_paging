...
import com.example.githubsearchapp.databinding.PartDefaultLoadStateBinding
...
class DefaultLoadStateAdapter(
    ...
    class Holder(
        ...
        fun bind(loadState: LoadState) = with(binding)
        {
            ...
            if(loadState is LoadState.Error) messageTextView.text = loadState.error.message
